...
<section class="hero">
  <div class="shell hero-grid">
    <div class="hero-copy">
      <p class="eyebrow">Central banking · Research · Statistics</p>
      <h1>Research that connects<br>evidence with policy.</h1>
      <p class="hero-lead">I am Executive Director of the Research and Statistics Department at the Czech National Bank. My work sits at the intersection of central banking, financial stability, macro-financial policy and applied research.</p>
      <div class="hero-actions">
        <a class="button primary" href="/research/">Explore research</a>
        <a class="button text" href="/about/">About me <span aria-hidden="true">→</span></a>
      </div>
...
<section class="section section-tint">
  <div class="shell">
    <div class="section-heading"><p class="eyebrow">Current focus</p><h2>Where research, policy and infrastructure meet.</h2></div>
    <div class="focus-grid">
      <article><span>01</span><h3>Monetary policy & forecasting</h3><p>Forecasting frameworks, transmission, model design and the practical use of evidence in monetary policy.</p></article>
      <article><span>02</span><h3>Financial stability & macro-finance</h3><p>Bank lending, macroprudential tools, distributional effects, climate risks and geopolitical shocks.</p></article>
      <article><span>03</span><h3>Research, data & modern central banking</h3><p>Research strategy, statistics, data access, reproducible analytics and new AI-enabled workflows.</p></article>
    </div>
  </div>
</section>
<section class="section">
  <div class="shell">
    <div class="section-heading split"><div><p class="eyebrow">Selected work</p><h2>Recent research</h2></div><a class="section-link" href="/research/">All research →</a></div>
    <div class="card-grid">{''.join(item_card(x, compact=True) for x in featured)}</div>
  </div>
</section>
<section class="section section-rule">
  <div class="shell two-col">
    <div><div class="section-heading"><p class="eyebrow">Latest</p><h2>Recent work & activity</h2></div>{''.join(latest_row(x) for x in latest_items)}</div>
    <aside class="upcoming-panel"><p class="eyebrow">Upcoming</p><h2>On the calendar</h2>{upcoming_html}</aside>
  </div>
</section>
'''
...
research_body = f'''
<section class="page-hero"><div class="shell narrow"><p class="eyebrow">Research</p><h1>Publications, working papers & ongoing projects.</h1><p>Research on monetary and macroprudential policy, banking, financial stability, climate and geopolitical risks, and central-bank policy design.</p></div></section>
<section class="section"><div class="shell">
  <div class="filter-panel" data-filter-scope>
    ...
    <details class="topic-filter"><summary>Filter by topic</summary><div class="chips secondary">{filtersM</div></details>
  </div>
...
policy_body = f'''
<section class="page-hero"><div class="shell narrow"><p class="eyebrow">Policy & talks</p><h1>Research translated into policy practice.</h1><p>Selected policy briefs, central-bank notes, invited talks, panels and media contributions.</p></div></section>
<section class="section"><div class="shell">
...
about_body = f'''
<section class="page-hero"><div class="shell narrow"><p class="eyebrow">About</p><h1>Economist, researcher and central-bank leader.</h1>{''.join(f'<p>{esc(p)}</p>' for p in about['intro'])}</div></section>
...
photos_body = f'''
<section class="page-hero"><div class="shell narrow"><p class="eyebrow">Photos</p><h1>Media & conference photos.</h1><p>These photographs may be used for media and conference purposes. Please credit the Czech National Bank.</p></div></section>
